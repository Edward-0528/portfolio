...
function App() {
  ...
  if (loading) {
    return (
      <div className="App flex items-center justify-center min-h-screen bg-surface">
        <div className="text-center">
          <div className="inline-flex items-center px-4 py-2 font-medium text-sm text-text-secondary">
