...
function App() {
  ...
  if (loading) {
    return (
      <div className="App flex items-center justify-center min-h-screen bg-[#0f0f1a]">
        <div className="text-center">
          <div className="inline-flex items-center px-4 py-2 font-medium text-sm text-gray-400">
